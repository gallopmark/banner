...
import com.xcode.banner.BannerIndicator;
import com.xcode.banner.R;
import com.xcode.banner.Utils;
import com.xcode.banner.loader.ImageLoader;
import com.xcode.banner.transformer.BannerPageTransformer;
...
public class Banner extends FrameLayout {
    ...
    public BannerInitializer with(@NonNull List<String> images) {
    ...
    protected void release() {
        stopAutoPlay();
        if (mPagerAdapter != null && isRegisterDataObserver) {
            mPagerAdapter.unregisterDataSetObserver(mAdapterDataObserver);
        }
    }
}
